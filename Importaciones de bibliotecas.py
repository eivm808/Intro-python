...
#Funcion 1: Mostrar fecha y hora actual
ahora = datetime.datetime.now()
print("Hora y fecha actual: ", ahora)

#Funcion 2: Mostrar solo fecha
...
#Funcion 1: Ver archivos de una carpeta

ruta = os.getcwd()
print("Ver archivos: ", ruta)

#Funcion 2: Obtener solo el nombre del archivo

print("Nombre de archivo: ",os.path.basename(ruta))
